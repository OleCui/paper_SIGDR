...
def process_data():
    ...
    drdr_similarity_graph, didi_similarity_graph, drdr_dissimilarity_graph, didi_dissimilarity_graph = process_similarity_graph(d_data, args)

    return d_data, drdr_similarity_graph, didi_similarity_graph, drdr_dissimilarity_graph, didi_dissimilarity_graph
...
def process_similarity_graph(d_data, args):
    ...
    drdr_dissimilarity_matrix_bool = KNN_matrix(d_data['dr_sim'], args.KNN_neighbor, isBool = True, isSimilarity = False)
    didi_dissimilarity_matrix_bool = KNN_matrix(d_data['di_sim'], args.KNN_neighbor, isBool = True, isSimilarity = False)

    d_data["drdr_dissimilarity_matrix"] = drdr_dissimilarity_matrix_bool
    d_data["didi_dissimilarity_matrix"] = didi_dissimilarity_matrix_bool
    ...
    drdr_dissimilarity_matrix = KNN_matrix(d_data['dr_sim'], args.KNN_neighbor, isBool = False, isSimilarity = False)
    didi_dissimilarity_matrix = KNN_matrix(d_data['di_sim'], args.KNN_neighbor, isBool = False, isSimilarity = False)
    drdr_dissimilarity_nx = nx.from_numpy_array(drdr_dissimilarity_matrix)
    didi_dissimilarity_nx = nx.from_numpy_array(didi_dissimilarity_matrix)
    drdr_dissimilarity_graph = dgl.from_networkx(drdr_dissimilarity_nx)
    didi_dissimilarity_graph = dgl.from_networkx(didi_dissimilarity_nx)
    drdr_dissimilarity_graph.ndata['sim_feature'] = torch.tensor(d_data['dr_sim'])
    didi_dissimilarity_graph.ndata['sim_feature'] = torch.tensor(d_data['di_sim'])

    return drdr_graph, didi_graph, drdr_dissimilarity_graph, didi_dissimilarity_graph
